...
export default class BookRequestScreen extends Component{
  ...
  addRequest =(bookName,reasonToRequest)=>{
    ...
    var books=await BookSearch.searchbook(bookName,'AIzaSyD_R_bXxj0rAYv1I8uilC_SLPDUZNODnIY')
  ...
  //render items to render the books for api
  renderItem=({item,i})=>{
    ...
    let Obj = {
      ...
      imageLink:item.volumeInfo.iamgeLinks,
